    ...
    <main className="mx-auto w-full max-w-5xl flex-1 px-4 py-12">
      ...
      <div className="mb-8">
        <h1 className="mb-2 font-heading text-3xl font-bold tracking-tight sm:text-4xl">
          <span className="font-mono text-primary">03</span> onde estou vs o mercado?
        </h1>
        <p className="max-w-2xl text-[0.95rem] leading-relaxed text-muted-foreground">
          Cole de 3 a 8 vagas e faça upload do seu CV para ver o que você já tem,
          o que está faltando e a sinergia com cada vaga.
        </p>
      </div>
